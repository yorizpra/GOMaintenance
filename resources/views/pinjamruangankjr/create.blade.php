...
<div class="container">
  ...
  <form method="post" action="/pinjamruangankjr">
  @csrf
  <div class="form-group">
    <label for="id_kajur"></label>
    @foreach($datas as $data)
    <input type="hidden" class="form-control @error('id_kajur') is-invalid @enderror" id="id_kajur" placeholder="" name="id_kajur" value="{{Session::get('id_kajur')}}">
    @endforeach
    @error('id_kajur')
  ...
  <!-- <div class="form-group">
    ...
    <input type="text" class="form-control @error('id_ruangan') is-invalid @enderror" id="id_ruangan" placeholder="" name="id_ruangan" value="{{$room->id_kajur}}">
    @endforeach
    @error('id_ruangan')
      <div class="invalid-feedback">
        {{$message}}
  ...
  <div class="form-group">
    <label for="nama">Nama Ketua Jurusan</label>
